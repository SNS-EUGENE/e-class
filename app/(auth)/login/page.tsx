          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-white/20 bg-white/5 text-orange-500 focus:ring-orange-500/50" />
                <span className="text-white/60">로그인 상태 유지</span>
              </label>
      ...
      <div className="hidden lg:block flex-1 relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="text-center">
            <h2 className="text-4xl font-semibold mb-4">배움의 시작</h2>
            <p className="text-lg text-white/60 max-w-md">
              6,000개 이상의 클래스에서 새로운 가능성을 발견하세요
            </p>
          </div>
        </div>
      </div>
